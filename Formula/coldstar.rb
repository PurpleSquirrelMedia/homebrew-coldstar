class Coldstar < Formula
  ...
  resource "jsonalias" do
    url "https://files.pythonhosted.org/packages/2a/df/59ca5f3319dc6d432d79303242f4c9fc50412de36d61de0f697d757faaba/jsonalias-0.1.2.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      On macOS, you may need to grant terminal disk access permissions
  ...
  test do
    ...
    assert_path_exists bin/"coldstar"
    assert_predicate bin/"coldstar", :executable?

    # Test Python imports work
    system libexec/"bin/python3", "-c", "import rich; import questionary; import solana"

    # Test main module can be imported
    system libexec/"bin/python3", "-c", "import sys; sys.path.insert(0, '#{libexec}'); import config"
  end
end
